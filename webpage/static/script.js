var margin = {left:80, top:40, right:80, bottom:50},
    ...
    innerRadius = Math.min(width * 0.13, height * .45),
...
d3.json('../animal-action-data', function (error, dataAgg) {
    ...
    var g = svg.append("g")
        .attr("transform", "translate(" + (width/2) + "," + (600/2 + margin.top) + ")")
        .datum(loom(dataAgg));
    ...
    outerLabels.append("text")
        ...
        .attr("dy", ".35em")
        .text(function(d,i){ return d.outername + " (" + numFormat(d.value) + ")"; });
    ...
    var innerLabels = g.append("g")
        ...
        .attr("x", function(d,i) { console.log(d); return d.x; })
        .attr("y", function(d,i) { console.log(i); return d.y; })
        ...
        .on("mouseover", function(d) {
            ...
            d3.selectAll(".outer-label-value")
                .text(function(s,i){
                    ...
                    return numFormat(value) + (value === 1 ? " omen" : " omens");
        ...
        .on("mouseout", function(d) {
            ...
            d3.selectAll(".outer-label-value")
                .text(function(s,i){ return numFormat(s.value) + " omens"; });
