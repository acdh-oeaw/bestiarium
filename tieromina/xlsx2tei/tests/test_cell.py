...
class CellTestCase(TestCase):
    ...
    def test_column_name(self):
        self.assertEqual(self.cell.column_name, 'A')
        self.assertEqual(self.red_cell.column_name, 'C')
        self.assertEqual(self.multipart_cell.column_name, 'F')
        self.assertEqual(self.empty_cell.column_name, 'A')
