...
class Workbook:
    ...
    def __init__(self, wbfile):
        ...
        _sheets = wb_xml.find('ns0:sheets', {
            'ns0':
        ...
        self.shared_strings = ss_xml.findall('ns:si', {
            'ns':
            'http://schemas.openxmlformats.org/spreadsheetml/2006/main'
        })
        styles_xml = ET.XML(self.z.read('xl/styles.xml'))
        self.styles = styles_xml.findall
    ...
    def get_sheet(self, sheet_num: int):
        ...
        try:
            ...
            return OmenSheet(workbook=self, sheet_xml=sheet_xml)
        except KeyError:
