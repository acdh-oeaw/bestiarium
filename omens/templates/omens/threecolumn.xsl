...
<xsl:stylesheet version="1.0"
    ...
    <xsl:key name="source" match="tei:body/tei:div/tei:div[@type = &apos;score&apos;]/tei:ab/tei:w/tei:app/tei:rdg" use="./@source"/>
    <xsl:template match="/">
        <div id="omens">
                ...
                <xsl:for-each select="//tei:witness">
                    ...
                    <xsl:if test="//*[@xml:id = $omenid]//tei:rdg[@wit = $witid]">
                        ...
                        <tr>
                            ...
                            <td>
                                <em>
                                    <xsl:value-of select="//*[@xml:id = $omenid]/tei:div[@type = &apos;score&apos;]/tei:ab/tei:cb[@ed = $witid]/@n" />
                                </em>
                                <em>
                                    <xsl:value-of select="//*[@xml:id = $omenid]/tei:div[@type = &apos;score&apos;]/tei:ab/tei:lb[@ed = $witid]/@n" />
                                </em>
                            </td>
                            <xsl:for-each select="//*[@xml:id = $omenid]/tei:div[@type = &apos;score&apos;]/tei:ab/tei:w">
                        ...
                        <xsl:for-each select="//*[generate-id() = generate-id(key('source',@source)[1])]">
                            <tr>
                                <xsl:if test="@source = //*[@xml:id = $omenid]/tei:div[@type = &apos;score&apos;]/tei:ab/tei:w/tei:app/tei:rdg[(@wit = $witid)]/@source">
                                    <td>
                                    ...
                                    <xsl:for-each select="//*[@xml:id = $omenid]/tei:div[@type = &apos;score&apos;]/tei:ab/tei:w">
                                        <xsl:sort select="./@xml:id"/>
                                        <td>
                                            <xsl:apply-templates select="tei:app/tei:rdg[(@wit = $witid) and (@source = $src)]" />
                                        </td>
                                    </xsl:for-each>
                                </xsl:if>
                            </tr>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="others">
                        <xsl:attribute name="id">
                            <xsl:value-of select="./@xml:id"/>
-others </xsl:attribute>
                        <xsl:attribute name="onclick"> toggleClass&#x28;this,&apos;<xsl:value-of select="./@xml:id"/>
-others&apos;&#x29; </xsl:attribute>
                    </input>
